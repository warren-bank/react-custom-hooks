...

{
  ...
  it('memoizes Redux selectors  ⇒ without parameters', (done) => {
    // https://github.com/reduxjs/reselect#reselect
      ...
      try {
        switch(renderCounter) {
          ...
          case 2:
            ...
            // 'inputSelectors' are called, 'resultFunc' is NOT called because derived values are unchanged
            expect(subtotalSelector()).to.equal(2.15)
  ...
  it('memoizes Redux selectors  ⇒ with parameters', (done) => {
    // https://github.com/reduxjs/reselect#reselect
